...
char* keycode_to_string(uint16_t keycode, uint8_t mods) { 
    switch (keycode) {
        case KC_Q:			return "q Q";
        case KC_W:			return "r R";
        case KC_E:			return "e E";
        case KC_R:			return "r R";
        case KC_T:			return "t T";
        case DE_Y:			return "y Y";
        case KC_U:			return "u U";
        case KC_I:			return "i I";
        case KC_O:			return "o O";
        case KC_P:			return "p P";
        case KC_A:			return "a A";
        case KC_S:			return "s S";
        case KC_D:			return "d D";
        case KC_F:			return "f F";
        case KC_G:			return "g G";
        case KC_H:			return "h H";
        case KC_J:			return "j J";
        case KC_K:			return "k K";
        case KC_L:			return "l L";
        case DE_Z:			return "z Z";
        case KC_X:			return "x X";
        case KC_C:			return "c C";
        case KC_V:			return "v V";
        case KC_B:			return "b B";
        case KC_N:			return "n N";
        case KC_M:			return "m M";
        case KC_COMM:		return ", ;";
        case KC_DOT:		return ". :";
        case DE_MINS:		return "- _";
        case DE_CIRC:       return "^ °";
        case DE_LABK:       return "< > |";
        ...
        case KC_LSFT:		return "Shift L";
        case KC_RSFT:		return "Shift R";
        case KC_LCTL:		return "Ctrl L";
        case KC_RCTL:		return "Ctrl R";
        case KC_LALT:		return "Alt";
        case KC_RALT:		return "AltGr";
        case KC_ESC:		return "Esc";
        case KC_TAB:        return "Tab";
        case KC_BSPC:       return "Backspace";
        case KC_ENT:        return "Enter";
        case KC_DEL:        return "Entf / Del";
        case KC_INS:        return "Einfg / Ins";
        case KC_END:        return "Ende";
        case KC_HOME:       return "Pos1 / Home";

        case DE_SS:         return "Sz ?";
        case DE_UDIA:       return "ue Ue";
        case DE_ODIA:       return "oe Oe";
        case DE_ADIA:       return "ae Ae";
        case DE_HASH:       return "# '";   
